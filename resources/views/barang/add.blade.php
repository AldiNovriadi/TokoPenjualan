...
<div class="row">
    <form class="form d-flex flex-column flex-lg-row" id="form-add" method="post" enctype="multipart/form-data" action="{{ route('barang.save') }}">
        @csrf
        <div class="col-md-12">
                ...
                <div class="card-body">
                    ...
                    <div class="row pt-3">
                        <div class="col-md-6 mb-10 fv-row">
                            ...
                            <input type="text" name="stok" class="form-control mb-2 format-number withseparator" placeholder="Stock" value="" />
                        </div>
                    </div>
                    <div class="row pt-3">
