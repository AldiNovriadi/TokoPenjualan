                ...
                <div class="card-body">
                    ...
                    <div class="row pt-3">
                        <div class="col-md-6 mb-10">
                            <div class="fv-row">
                                ...
                                <input type="text" name="nama_barang" id="nama_barang" class="form-control mb-2" placeholder="Barang" value="{{ $data->nama_barang }}" disabled/>
                        ...
                        <div class="col-md-1">
                            <div class="fv-row">
                                <label class="form-label">&nbsp;</label>
                                <div class="form-group mb-2">
                                    <button type="button" class="btn btn-primary" id="triggerBarang" disabled><i class="bi bi-search"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pt-3">
                        <div class="col-md-6 mb-10 fv-row">
                            ...
                            <input type="text" name="jumlah" class="form-control mb-2 format-number withseparator" placeholder="Jumlah" value="{{ number_format($data->jumlah, 0) }}" disabled/>
                        </div>
                    </div>
