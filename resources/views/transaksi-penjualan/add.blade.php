...
<div class="row">
    <form class="form d-flex flex-column flex-lg-row" id="form-add" method="post" enctype="multipart/form-data" action="{{ route('transaksi-penjualan.save') }}">
        @csrf
        <div class="col-md-12">
                ...
                <div class="card-body">
                    <div class="row pt-3">
                        <div class="col-md-6 mb-10">
                            <div class="fv-row">
                                ...
                                <input type="text" name="nama_jenis_barang" id="nama_jenis_barang" class="form-control mb-2" placeholder="Jenis Barang" readonly/>
                    ...
                    <div class="row pt-3">
                        <div class="col-md-6 mb-10">
                            <div class="fv-row">
                                ...
                                <input type="text" name="nama_barang" id="nama_barang" class="form-control mb-2" placeholder="Barang" readonly/>
                    ...
                    <div class="row pt-3">
                        <div class="col-md-6 mb-10 fv-row">
                            ...
                            <input type="text" name="jumlah" id="jumlah" class="form-control mb-2 format-number withseparator" placeholder="Jumlah" value="" />
                        </div>
                    </div>
